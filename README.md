...
A historical strategy game about the Turkish War of Independence, from Mustafa
...
- **Attack** — pick a province, then an adjacent enemy. Dice resolve it, with
  blitz resolution and exact odds behind the AI's decisions.
...
of actions — a single turn offers hundreds of from→to pairs, and one output per
